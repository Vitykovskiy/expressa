...
| `#6 Slice A runtime, CI, and validation path` | `implementation` | `devops` | `#4` | `#2, #3, #4` | `docs/analysis/version-scope-and-acceptance.md`, `docs/analysis/cross-cutting-concerns.md`, `docs/09-integrations.md` | `Runtime and pipeline path for deployment and tests` |
