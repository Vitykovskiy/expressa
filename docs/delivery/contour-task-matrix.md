...
| `#5 Slice A customer/backoffice APIs and order rules` | `implementation` | `backend` | `#4` | `#2, #3, #4` | `docs/analysis/version-scope-and-acceptance.md`, `docs/analysis/system-modules.md`, `docs/analysis/domain-model.md`, `docs/analysis/integration-contracts.md`, `docs/analysis/cross-cutting-concerns.md` | `Contract-compliant backend for slice A with rule coverage` |
| `#6 Slice A runtime, CI, and validation path` | `implementation` | `devops` | `#4` | `#2, #3, #4` | `docs/analysis/version-scope-and-acceptance.md`, `docs/analysis/cross-cutting-concerns.md`, `docs/09-integrations.md`, `docs/delivery/stage0-infrastructure-baseline.md` | `Runtime and pipeline path for deployment and tests` |
| `#7 Slice A fixtures and automated validation assets` | `implementation` | `qa-e2e` | `#4` | `#2, #5, #6` | `docs/analysis/user-scenarios.md`, `docs/analysis/version-scope-and-acceptance.md`, `docs/analysis/cross-cutting-concerns.md` | `Reusable QA assets for block-level validation` |
